...
const Ask = (props: Props) => {
  ...
  const AskCard = (AskProps: QA) => {
    ...
    return (
      <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-1000 dark:text-gray-100">
          ...
          <div className="space-x-2">
            ...
            >
              <svg
                ...
                viewBox="0 0 512 512"
                className="w-4 h-4 fill-current dark:text-green-400"
              >
      ...
      <section className="dark:bg-gray-800 dark:text-gray-100">
        <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
          ...
          <section className="flex flex-col py-10">
            <h1 className="text-2xl text-white font-semibold flex space-x-2 items-center">
