        ...
        <div className="grid gap-4 mx-4 sm:grid-cols-12">
          <div className="col-span-12 sm:col-span-3">
            ...
            <div className="flex flex-col space-y-1 py-6 text-gray-1000 text-sm">
              <h4 className="">Total Calories: {totalCalories}</h4>
              <h4 className="">Total Carbohydrates: {totalCarbohydrates}</h4>
              <h4 className="">Total Fat: {totalFat}</h4>
              <h4 className="">Total Proteins: {totalProteins}</h4>
            </div>
          </div>
          <div className="grid grid-cols-4 gap-4 px-4 space-y-6">
